...
def pretrain(model_name, train_data, val_data, job_id, scratch_model, scratch_token):
    ...
    training_losses = []
    val_losses = []
    val_batch = tokenizer(val_data, return_tensors = 'pt', padding=True, truncation=True, max_length = 128)
    ...
    for epoch in range(epochs):
        ...
        batch = tokenizer(train_data, return_tensors = 'pt', padding=True, truncation=True, max_length = 128)
...
def main(model_name, data_dir, logger, job_id):
    ...
    file_list = ['Swissprot_Eukaryotes.csv', 'Swissprot_Prokaryotes.csv', 'Uniprot_Eukaryotes2.csv', 'Uniprot_Prokaryotes2.csv'] #, 'Uniprot_Eukaryotes.csv', 'Swissprot_Eukaryotes.csv', 'Swissprot_Prokaryotes.csv', 'Swissprot_Prokaryotes.csv'
